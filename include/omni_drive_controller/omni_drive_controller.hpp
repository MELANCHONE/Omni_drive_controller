...
#include "omni_drive_controller/omni_drive_controller_parameters.hpp"
...
class OmniDriveController : public controller_interface::ChainableControllerInterface
{
public:
  OMNI_DRIVE_CONTROLLER__VISIBILITY_PUBLIC
  OmniDriveController();
...
protected:
  std::shared_ptr<omni_drive_controller::ParamListener> param_listener_;
  omni_drive_controller::Params params_;
  ...
  //添加一个tf发布器
  using TransformStampedPublisher = realtime_tools::RealtimePublisher<geometry_msgs::msg::TransformStamped>;
  rclcpp::Publisher<geometry_msgs::msg::TransformStamped>::SharedPtr transform_stamped_pub_;
  std::unique_ptr<TransformStampedPublisher> rt_transform_stamped_publisher_;
...
private:
  ...
  OMNI_DRIVE_CONTROLLER__VISIBILITY_LOCAL
